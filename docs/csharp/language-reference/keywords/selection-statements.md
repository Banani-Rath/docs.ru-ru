---
title: "Инструкции выбора (Справочник по C#) | Microsoft Docs"
ms.custom: ""
ms.date: "11/24/2016"
...
dev_langs: 
  - "CSharp"
helpviewer_keywords: 
  - "операторы [C#], выделенный фрагмент"
...
Инструкция выбора позволяет программе передать управление определенному потоку команд в зависимости от выполнения условия `true`.  
  
 В инструкциях выбора могут использоваться следующие ключевые слова.  
