---
title: "Операторы и выражения (Руководство по программированию на C#) | Microsoft Docs"
ms.custom: ""
ms.date: "11/24/2016"
...
Код приложений в C\# состоит из операторов, состоящих из ключевых слов, выражений и операторов.  В этом разделе содержатся сведения об этих основных элементах программы на языке C\#.  
