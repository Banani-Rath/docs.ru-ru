---
title: "Класс &lt;имяКласса&gt; не найден | Microsoft Docs"
ms.custom: ""
ms.date: "11/24/2016"
...
Не удается найти класс "\<имя\_класса\>".Это состояние, как правило, является результатом использования несоответствующей библиотеки "Microsoft.VisualBasic.dll".  
