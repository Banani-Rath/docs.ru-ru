---
title: "Сводка по вводу и выводу (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "11/24/2016"
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "ввод-вывод [Visual Basic], функции"
  - "ввод, функции Visual Basic"
  - "результат, функции Visual Basic"
...
|--------------|-------------------|  
|Получение доступа к файлу или создание файла.|<xref:Microsoft.VisualBasic.FileSystem.FileOpen%2A>|  
|Закрытие файлов.|<xref:Microsoft.VisualBasic.FileSystem.FileClose%2A>, <xref:Microsoft.VisualBasic.FileSystem.Reset%2A>|  
|Управление видом вывода.|<xref:Microsoft.VisualBasic.Strings.Format%2A>, <xref:Microsoft.VisualBasic.FileSystem.Print%2A>, <xref:Microsoft.VisualBasic.FileSystem.SPC%2A>, <xref:Microsoft.VisualBasic.FileSystem.TAB%2A>, <xref:Microsoft.VisualBasic.FileSystem.FileWidth%2A>|  
...
|Получение или предоставление сведений от\/для пользователя с помощью элемента управления диалогового окна.|<xref:Microsoft.VisualBasic.Interaction.InputBox%2A>, <xref:Microsoft.VisualBasic.Interaction.MsgBox%2A>|  
...
|Возвращение размера файла.|<xref:Microsoft.VisualBasic.FileSystem.FileLen%2A>|  
|Установка или получение атрибутов файла.|<xref:Microsoft.VisualBasic.FileSystem.FileAttr%2A>, <xref:Microsoft.VisualBasic.FileSystem.GetAttr%2A>, <xref:Microsoft.VisualBasic.FileSystem.SetAttr%2A>|  
|Установка позиции чтения\-записи в файле.|<xref:Microsoft.VisualBasic.FileSystem.Seek%2A>|  
